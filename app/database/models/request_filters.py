...
class RequestFilters(Base):
    ...
    year_from: Mapped[int] = mapped_column(nullable=False)
    year_to: Mapped[int] = mapped_column(nullable=False)
    odo_from: Mapped[int] = mapped_column(nullable=False)
    odo_to: Mapped[int] = mapped_column(nullable=False)
