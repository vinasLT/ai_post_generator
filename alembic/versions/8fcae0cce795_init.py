...
Revision ID: 8fcae0cce795
Revises: 
Create Date: 2025-10-14 18:39:37.878595
...
def upgrade() -> None:
    ...
    sa.Column('stage', sa.Enum('FAILED', 'IN_PROGRESS', 'COMPLETED', name='requeststage'), nullable=True),
